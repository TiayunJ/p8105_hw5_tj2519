...
## Write a function to read the data in each csv filecreate another dataframe to store the data in each csv file, 
```{r}
...
pro2_df = 
  pro2_df %>% 
  mutate(data = map(pull(pro2_df, file), read_data) %>% 
  bind_rows()
           )
