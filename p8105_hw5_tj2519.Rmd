...
df_certain_mean = function(true_mean) {
  
  map(1:10, ~ rnorm(30, mean = true_mean, sd = 5))
...
a = 
  tibble(mean = 1:6) %>% 
  mutate(data = map(mean, df_certain_mean))
  



  
my_list <- list(seq(1, 6))
my_vector <- unlist(my_list)


map(my_vector, df_certain_mean)
